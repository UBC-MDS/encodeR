...
<!-- badges: end -->
  ...
  Please read [this vignette](https://ubc-mds.github.io/encodeR/articles/encodeR-vignette.html) for a hands on guide on how to use encodeR.
...
4. `conjugate_encoder()`: calculates encodings based off Bayes rule using conjugate priors and the mean of the posterior distribution. The original paper for this method can be found [here.](https://arxiv.org/pdf/1904.13001.pdf)
